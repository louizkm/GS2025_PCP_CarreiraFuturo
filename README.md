...
Sugestão de evidências para a entrega:

- **Prints de tela** do terminal:
  - Cadastro de perfil;
  - Geração de recomendações;
  - Arquivo `.txt` criado.
- Opcional: gravar um vídeo curto (screen recording) mostrando o uso do sistema e hospedar no YouTube, incluindo o link aqui.
